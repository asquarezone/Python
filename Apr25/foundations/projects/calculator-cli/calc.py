"""This module is starter for cli application

It proceses the arguments
"""
import argparse
...
def create_argument_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("-t", "--type", type=str,
                        choices=['sip', 'lumpsum'], default='sip', help="Type of calculator")
    parser.add_argument("-p", "--principal", type=float,
                        help="Investment Amount")
    parser.add_argument("-d", "--duration", type=int,
                        help="investment duration in months")
    parser.add_argument("-r", "--rate", type=float,
                        help="investment return rate")
    return parser
